...
gladstone is a stater sub-theme for Corolla 7.x-2.x and can be easily
...
name from gladstone, then read on.

1. Copy this entire theme and change the name of the folder. Currently the name of the folder
	 is "gladstone", so you might choose "bartheme". In the next step we will use this name for
...
2. gladstone.info - first rename this file to match the folder name you chose in step one. Next you
...
4. template.php - open up this file and make some changes - search and replace "gladstone" for your
	 themes name.

	 In gladstone_preprocess_html() you will find some stuff about responsive stylesheets and IE conditional
